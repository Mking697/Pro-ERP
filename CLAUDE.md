...
**Next: phase 4 — PPC.** The shared-pool allocation is the part that matters; see the plan doc. Needs two more sheets connected: `Production_Plans` and `Plan_Materials`.
