...
| **4** ✅ | PPC — plan builder, shared-pool allocation, reserve, Start Production. Verified live: 5049.5 screws split across two products needing 5600 gave the earlier date its full 4000 and left the later one short 550.5 — the figure a per-product check would have reported as Ready. Starting production for 380 of a planned 400 consumed 3800 and released the other 200 the same moment. Rechecking a short plan absorbed exactly the freed 200; cancelling returned everything it held. |
