...
export const EN: Record<string, string> = {
  ...
  "Leave — Quota Setup": "Leave — Quota Setup",
  "Har Leave Type ke liye saalana kitne din milte hain — khaali ya 0 rakhein to us type par koi limit nahi hogi. Yahan set kiya gaya quota har financial/calendar year me apne aap reset ho jaata hai (koi carry-forward nahi).":
    "How many days a year each Leave Type gets — leave a type blank or 0 for no limit on it. A quota set here resets automatically every calendar year (no carry-forward).",
  "Leave Quota Setup load nahi ho paya.": "Leave Quota Setup could not be loaded.",
  "Leave Quota Setup load ho raha hai": "Loading Leave Quota Setup",
  "Unlimited": "Unlimited",
  "Is saal ka balance:": "This year's balance:",
  "din bache hain": "days left",
  ...
  // --- accounts: Receivables/Payables/Ledger tabs, Payables board, GL reports --------------
  "Receivables (Invoice), Payables (Bill) aur poori General Ledger — Chart of Accounts, Trial Balance, P&L aur Balance Sheet.":
    "Receivables (Invoice), Payables (Bill) and the full General Ledger — Chart of Accounts, Trial Balance, P&L and Balance Sheet.",
  "Receivables": "Receivables",
  "Payables": "Payables",
  "Ledger": "Ledger",

  // --- accounts: Additional Payments (Other Payments tab) ------------------------------
  "Other Payments": "Other Payments",
  "+ Naya Expense": "+ New Expense",
  "Naya Expense": "New Expense",
  "Rent, salary, utilities ya kisi bhi one-off Cash/Bank kharch ke liye — kisi Order/PO se juda nahi.":
    "For rent, salary, utilities, or any one-off Cash/Bank expense — not tied to any Order/PO.",
  "Category": "Category",
  ...
  "Expense Record Karein": "Record Expense",
  "Expense record ho gaya.": "Expense recorded.",
  "Expense categories load nahi ho payin.": "Could not load expense categories.",
  "Expenses load nahi ho paye.": "Could not load expenses.",
  "Abhi koi Additional Payment nahi hai": "No Additional Payments yet",
  "Rent, salary, utilities ya kisi bhi one-off kharch ke liye '+ Naya Expense' dabayein.":
    "Press '+ New Expense' for rent, salary, utilities, or any one-off payment.",

  // --- accounts: Petty Cash Book (Petty Cash tab) ---------------------------------------
  "Petty Cash": "Petty Cash",
  "Petty Cash load nahi ho paya.": "Could not load Petty Cash.",
  "Petty Cash — Available Balance": "Petty Cash — Available Balance",
  "Available Balance": "Available Balance",
  "Abhi Petty Cash me koi entry nahi hai": "No Petty Cash entries yet",
  "'+ Top Up' se fund me paisa daal kar shuru karein.": "Use '+ Top Up' to put money into the fund and get started.",
  "Counter Account": "Counter Account",
  "Balance": "Balance",
  "Top Up": "Top Up",
  "+ Top Up": "+ Top Up",
  "Top Up Karein": "Top Up",
  "Petty Cash Top Up": "Petty Cash Top Up",
  "Petty Cash Top Up ho gaya.": "Petty Cash topped up.",
  "Cash/Bank se Petty Cash fund me paisa daalein.": "Put money into the Petty Cash fund from Cash/Bank.",
  "+ Record Expense": "+ Record Expense",
  "Petty Cash Expense": "Petty Cash Expense",
  "Petty Cash se Expense record ho gaya.": "Expense recorded from Petty Cash.",

  // --- accounts: Credit Notes (Sales Return / Transit Loss / Price Adjustment) ----------
  "Credit Notes": "Credit Notes",
  "Credit Note": "Credit Note",
  "Credit Note Issue Karein": "Issue Credit Note",
  "Credit Note ban gaya.": "Credit Note created.",
  "Credit Note No.": "Credit Note No.",
  "Credit Notes load nahi ho paye.": "Could not load Credit Notes.",
  "Abhi koi Credit Note nahi hai": "No Credit Notes yet",
  "Ek Issued Invoice ke detail me se 'Credit Note Issue Karein' se shuru karein.":
    "Start from an Issued Invoice's own detail view — 'Issue Credit Note'.",
  "Poora use ho gaya": "Fully used",
  "Apply": "Apply",
  "Refund": "Refund",
  "Apply Karein": "Apply",
  "Refund Karein": "Refund",
  "Credit Note Apply Karein": "Apply Credit Note",
  "Credit Note Refund Karein": "Refund Credit Note",
  "Credit Note order par apply ho gaya.": "Credit Note applied to the order.",
  "Credit Note refund ho gaya.": "Credit Note refunded.",
  ...
  "Bill (Draft) ban gayi.": "Bill (Draft) created.",
  "Nayi Bill": "New Bill",
  "Vendor Bill No. (optional)": "Vendor Bill No. (optional)",
  "Vendor Bill No.": "Vendor Bill No.",
  "Bill Document (optional yaha, Issue karne se pehle zaroori)": "Bill Document (optional here, required before Issue)",
  "Bill Document": "Bill Document",
  "Bill Document dekhein": "View Bill Document",
  "Bill (Draft) Banayein": "Create Bill (Draft)",
  "Abhi koi naya Bill candidate nahi hai": "There are no new bill candidates yet",
  "Koi Purchase Order Material Received (Completed) hote hi wo yahan aa jaayega.":
    "As soon as a Purchase Order is Material Received (Completed), it will appear here.",
  "PO Value": "PO Value",
  "Bill Banayein": "Create Bill",
  "Bills load nahi ho payi.": "Could not load bills.",
  "Abhi koi bill nahi hai": "There are no bills yet",
  "Needs Billing se ek PO chunkar bill banayein.": "Choose a PO from Needs Billing to create a bill.",
  "Bill load nahi ho payi.": "Could not load the bill.",
  "Bill save ho gayi.": "Bill saved.",
  "Bill Issue ho gayi.": "Bill issued.",
  "Payment record ho gaya.": "Payment recorded.",
  ...
  "Haan": "Yes",
  "Nahi": "No",
  "Chart of Accounts load nahi ho paya.": "Could not load the Chart of Accounts.",
  "Trial Balance load nahi ho payi.": "Could not load the Trial Balance.",
  "P&L load nahi ho paya.": "Could not load the P&L.",
  "Balance Sheet load nahi ho payi.": "Could not load the Balance Sheet.",
  "Koi account nahi mila": "No account found",
  "From (optional)": "From (optional)",
  "To (optional)": "To (optional)",
  "Is range me koi entry nahi hai": "There is no entry in this range",
  "Income": "Income",
  "Total Income": "Total Income",
  "Expense": "Expense",
  "Total Expense": "Total Expense",
  "Net Profit": "Net Profit",
  "As of (optional, khaali chhodne par aaj tak)": "As of (optional, defaults to today if left blank)",
  ...
  "Status": "Status",
  "Delivered": "Delivered",
  "Order Poora Deliver Ho Gaya": "Order Fully Delivered",
  "Mark Delivered": "Mark Delivered",
  "Mark Delivered nahi ho paya.": "Could not Mark Delivered.",
  "Shipment Deliver ho gayi.": "Shipment has been delivered.",
  "Proof of Delivery (optional)": "Proof of Delivery (optional)",
  "Deliver ho gaya": "Delivered by",
  "Proof of Delivery dekhein": "View Proof of Delivery",
  "Ye order ab poora Deliver ho chuka hai — Sales chain ka safar yahan poora hota hai.":
    "This order is now fully delivered — this is where its journey through the Sales chain ends.",
  ...
  "Salary structure aur monthly payroll runs — abhi ke liye koi PF/ESI/TDS deduction nahi hai.":
    "Salary structures and monthly payroll runs — no PF/ESI/TDS deduction for now.",
  "Meri Payslips": "My Payslips",
  "Payslips load nahi ho payi.": "Could not load payslips.",
  "Abhi tak koi payslip nahi hai.": "There are no payslips yet.",
  "Jab Admin aapke month ka payroll run finalize karega, wo yahan dikhega.":
    "Once your Admin finalizes your month's payroll run, it will show up here.",
  "Nahi bana": "Not generated",
  "Salary set nahi ho payi.": "Could not set salary.",
  "Salary set ho gayi.": "Salary has been set.",
  "Salary set karein": "Set salary",
  "Naya monthly salary ek nayi row ke roop me save hota hai — purane months ka payroll purani salary se hi calculate hota rahega.":
    "A new monthly salary is saved as a new row — past months' payroll will still be calculated against the old salary.",
  "Salary structures load nahi ho paye.": "Could not load salary structures.",
  "Salary Structures": "Salary Structures",
  "Har user ki current monthly salary. Ek raise nayi effective date se lagu hoti hai.":
    "Every user's current monthly salary. A raise applies from a new effective date.",
  "Koi user nahi mila.": "No user found.",
  "Set nahi hai": "Not set",
  "Payslips load nahi ho paye.": "Could not load payslips.",
  "Payslips dekhein": "View payslips",
  "Ye run Finalized hai — iske payslips ab fixed hain.":
    "This run is Finalized — its payslips are now fixed.",
  "Ye run abhi Draft hai — dobara Generate karne par ye payslips replace ho jaayenge.":
    "This run is still Draft — regenerating it will replace these payslips.",
  "Is run me koi payslip nahi hai.": "This run has no payslips.",
  "Payroll Runs": "Payroll Runs",
  "Ek month select karke Generate karein — Draft run dobara Generate karne par replace ho jaata hai. Finalize karne ke baad wo permanent record ban jaata hai aur payslip PDFs bante hain.":
    "Select a month and Generate — regenerating a Draft run replaces it. Once Finalized, it becomes a permanent record and payslip PDFs are created.",
  "Payroll runs load nahi ho paye.": "Could not load payroll runs.",
  "Generate karein": "Generate",
  "Payroll run generate nahi ho paya.": "Could not generate the payroll run.",
  "Payroll run generate ho gaya.": "Payroll run generated.",
  "Finalize nahi ho paya.": "Could not finalize.",
  "Payroll run Finalize ho gaya. Payslip PDFs ban rahe hain.":
    "Payroll run finalized. Payslip PDFs are being generated.",
  "Abhi tak koi payroll run nahi hai.": "There are no payroll runs yet.",
  "Finalize karein": "Finalize",
  "Payroll run nahi mila.": "Payroll run not found.",
  "Ye payroll run pehle se Finalized hai.": "This payroll run is already Finalized.",
  "Payroll run finalize nahi ho paya.": "Could not finalize the payroll run.",
  "Payroll run create nahi ho paya. Dobara try karein.":
    "Could not create the payroll run. Please try again.",
  "Monthly salary 0 se zyada honi chahiye.": "Monthly salary must be greater than 0.",
  "Effective From date 'YYYY-MM-DD' format me hona chahiye.":
