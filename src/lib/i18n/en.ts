...
export const EN: Record<string, string> = {
  ...
  "Quotation Accept hote hi Intake me aata hai, ya seedha Direct order banayein — Payment/Credit review, Stock reserve, aur Dispatch commit tak.":
    "Once a Quotation is Accepted it lands in Intake, or start a Direct order right away — through Payment/Credit review, Stock reservation, and Dispatch commit.",
  "+ Naya Order": "+ New Order",
  "Naya Order (Direct)": "New Order (Direct)",
  "Bina Lead/Quotation ke — seedha Customer aur Items chun kar order banayein.":
    "Without a Lead/Quotation — pick a Customer and Items directly to create an order.",
  "Load ho raha hai": "Loading",
  "Intake candidates load nahi ho paye.": "Could not load Intake candidates.",
  "Orders load nahi ho paye.": "Could not load orders.",
  "Abhi koi naya Order candidate nahi hai": "There are no new Order candidates yet",
  "Koi Quotation Accept hote hi wo yahan aa jaayega.": "Once a Quotation is Accepted it will appear here.",
  "Party": "Party",
  "Accepted": "Accepted",
  "Map Karein": "Map",
  "Abhi koi order nahi hai": "There are no orders yet",
  "Direct order banayein ya Intake se ek Quotation map karein.":
    "Create a Direct order, or map a Quotation from Intake.",
  "Bana": "Created",
  "Order Banayein": "Create Order",
  "Har line ko ek real Item se map karein, aur Customer Master confirm ya naya banayein.":
    "Map every line to a real Item, and confirm or add a Customer Master row.",
  "Line Items Map Karein": "Map Line Items",
  "Har line ke liye ek Item chunein.": "Choose an Item for every line.",
  "Order ban gaya.": "Order created.",
  "Quotation": "Quotation",
  "Total": "Total",
  "PO Attachment (optional)": "PO Attachment (optional)",
  "Har item ki quantity 0 se zyada honi chahiye.": "Every item's quantity must be greater than 0.",
  "Order load nahi ho paya.": "The order could not be loaded.",
  "Reserved": "Reserved",
  "Short": "Short",
  "Ye order Intake se abhi map ho raha hai.": "This order is currently being mapped from Intake.",
  "Payment Review": "Payment Review",
  "Customer ka credit/advance check karke ye Stock_Check ya Credit_Hold me jaayega.":
    "After checking the customer's credit/advance, this will move to Stock_Check or Credit_Hold.",
  "Payment Review Chalayein": "Run Payment Review",
  "Credit Hold": "Credit Hold",
  "Approve Karein": "Approve",
  "Stock Check": "Stock Check",
  "Free FG stock is order ke items ke liye reserve hoga.": "Free FG stock will be reserved for this order's items.",
  "Stock Check Chalayein": "Run Stock Check",
  "Dispatch Commit Date": "Dispatch Commit Date",
  "Commit Karein": "Commit",
  "Ready For PDI — Order FMS ka kaam yahin khatam ho jaata hai.":
    "Ready For PDI — Order FMS's own job ends right here.",
  "Ye order cancel ho chuka hai.": "This order has been cancelled.",
  "Order Cancel Karein": "Cancel Order",
  "Reason (optional)": "Reason (optional)",
  "Payments": "Payments",
  "Payment Record Karein": "Record Payment",
  "Order Setup load nahi ho paya.": "Order Setup could not be loaded.",
  "Order Setup save ho gaya.": "Order Setup saved.",
  "Order Setup load ho raha hai": "Loading Order Setup",
  ...
  "Items Mapping se Dispatch Commit tak — har step ka Doer aur TAT set karein, aur Credit Hold clear karne wala approver chunein.":
    "From Items Mapping through Dispatch Commit — set each step's Doer and TAT, and choose who may clear a Credit Hold.",
  "Items Mapping": "Items Mapping",
  "Dispatch Commit": "Dispatch Commit",
  "Credit-Hold Approver": "Credit-Hold Approver",
  ...
  // --- orders: transport arrangement (retrofit) -----------------------------------------
  "Transport Arrangement": "Transport Arrangement",
  "Self (Hum Arrange Karenge — Freight Paid)": "Self (we arrange — Freight Paid)",
  "Party (Customer Khud Arrange Karega — To Pay)": "Party (customer arranges their own pickup — To Pay)",

  // --- tms -------------------------------------------------------------------------------
  "TMS (Transport)": "TMS (Transport)",
  "PDI Pass hote hi order yahan aata hai — Self-arranged shipment plan karein ya Party ke pickup ka Follow Up/Loading Dock confirm karein.":
    "Once PDI passes, an order lands here — plan a Self-arranged shipment, or Follow Up/confirm the Loading Dock for a Party pickup.",
  "Abhi koi naya TMS candidate nahi hai": "There are no new TMS candidates yet",
  "Koi order ki PDI Pass hote hi wo yahan aa jaayega.": "Once an order's PDI passes it will appear here.",
  "Transport": "Transport",
  "Decision Chahiye": "Decision Needed",
  "Self": "Self",
  "Party (Customer)": "Party (Customer)",
  "Partially Shipped": "Partially Shipped",
  "Not Shipped Yet": "Not Shipped Yet",
  "Abhi koi shipment nahi hai": "There are no shipments yet",
  "Candidate se shipment plan hote hi wo yahan aa jaayegi.": "Once a shipment is planned from a candidate it will appear here.",
  "Abhi koi order poora ship nahi hua": "No order has been fully shipped yet",
  "Jab kisi order ki saari lines ship ho jaayengi, wo yahan dikhega.": "Once every line of an order has shipped, it will show up here.",
  "Vehicle": "Vehicle",
  "Fully Shipped": "Fully Shipped",
  "Vendors": "Vendors",
  "Order TMS details load nahi ho paye.": "Could not load this order's TMS details.",
  "Transport arrangement set ho gaya.": "Transport arrangement has been set.",
  "Self (Freight Paid)": "Self (Freight Paid)",
  "Party (To Pay)": "Party (To Pay)",
  "Details aur shipment actions": "Details and shipment actions",
  "Transport Arrangement Set Karein": "Set Transport Arrangement",
  "Ye order transport arrangement (Self/Party) set hue bina bana tha — pehle wo decide karein.":
    "This order was created before a transport arrangement (Self/Party) was set — decide that first.",
  "Set Karein": "Set",
  "Shipment Progress": "Shipment Progress",
  "Shipped": "Shipped",
  "Baaki": "Remaining",
  "+ Naya Shipment Plan Karein": "+ Plan a New Shipment",
  "Ye order poora ship ho chuka hai.": "This order has been fully shipped.",
  "Shipments": "Shipments",
  "Abhi koi shipment plan nahi hui hai.": "No shipment has been planned yet.",
  "Follow-up log ho gaya.": "Follow-up logged.",
  "Loading Dock confirm ho gaya.": "Loading Dock confirmed.",
  "At Loading Dock": "At Loading Dock",
  "Driver": "Driver",
  "Loading Dock Confirm Karein": "Confirm Loading Dock",
  "Note (optional)": "Note (optional)",
  "Vehicle No.": "Vehicle No.",
  "Driver Contact No.": "Driver Contact No.",
  "Confirm Karein": "Confirm",
  "Loading Dock confirm kiya": "Loading Dock confirmed by",
  "Transport Vendors load nahi ho paye.": "Could not load Transport Vendors.",
  "Kam se kam ek line allocate karein.": "Allocate at least one line.",
  "Transport Vendor chunein.": "Select a Transport Vendor.",
  "Vehicle Size dein.": "Enter the vehicle size.",
  "Shipment plan ho gaya.": "Shipment planned.",
  "Naya Shipment Plan Karein": "Plan a New Shipment",
  "Vehicle/vendor chunein aur jo lines is truck me jaa rahi hain unki quantity dein.":
    "Choose the vehicle/vendor and enter the quantity of each line riding on this truck.",
  "Customer khud pickup arrange kar raha hai — jo lines is pickup me jaa rahi hain unki quantity dein.":
    "The customer is arranging their own pickup — enter the quantity of each line in this pickup.",
  "Transport Vendor": "Transport Vendor",
  "Vehicle Size": "Vehicle Size",
  "Vehicle Price (Freight)": "Vehicle Price (Freight)",
  "From Warehouse": "From Warehouse",
  "To Address": "To Address",
  "Vehicle No. (optional)": "Vehicle No. (optional)",
  "Driver Contact No. (optional)": "Driver Contact No. (optional)",
  "Line Allocation": "Line Allocation",
  "Koi line baaki nahi hai.": "No line remains.",
  "Shipment Plan Karein": "Plan Shipment",
  "Fully Shipped orders load nahi ho paye.": "Could not load fully-shipped orders.",
  "Shipments load nahi ho paye.": "Could not load shipments.",
  "Transport Vendor ban gaya.": "Transport Vendor created.",
  "Add Transport Vendor": "Add Transport Vendor",
  "Naya Transport Vendor": "New Transport Vendor",
  "Sirf Vendor Name zaroori hai, baaki details baad me bhi bhari ja sakti hain.":
    "Only the Vendor Name is required — the rest of the details can be filled in later.",
  "Transport Vendors load ho rahe hain": "Loading Transport Vendors",
  "Abhi koi Transport Vendor nahi hai.": "There are no Transport Vendors yet.",

  // --- accounts --------------------------------------------------------------------------
  "Accounts": "Accounts",
  "PDI Pass hote hi order yahan Invoice banane ke liye aata hai — Invoice No., E-way Bill aur documents dekar Issue karein.":
    "Once PDI passes, an order lands here to be invoiced — give the Invoice No., E-way Bill and documents, then Issue it.",
  "Invoices load nahi ho payi.": "Could not load invoices.",
  "Abhi koi naya Invoice candidate nahi hai": "There are no new invoice candidates yet",
  "Invoice Banayein": "Create Invoice",
  "Abhi koi invoice nahi hai": "There are no invoices yet",
  "Needs Invoicing se ek order chunkar invoice banayein.": "Choose an order from Needs Invoicing to create an invoice.",
  "Invoice No.": "Invoice No.",
  "Final Value": "Final Value",
  "Suggested value load nahi ho payi.": "Could not load the suggested value.",
  ...
  "E-way Bill Document (optional)": "E-way Bill Document (optional)",
  "Extra Document (optional)": "Extra Document (optional)",
  "Invoice (Draft) Banayein": "Create Invoice (Draft)",
  "Invoice load nahi ho payi.": "Could not load the invoice.",
  "Invoice save ho gayi.": "Invoice saved.",
  "Invoice Issue ho gayi.": "Invoice issued.",
  "Details": "Details",
  "Invoiced": "Invoiced",
  "Invoice Document": "Invoice Document",
  "Invoice Document dekhein": "View Invoice Document",
  "E-way Bill No.": "E-way Bill No.",
  "E-way Bill Document": "E-way Bill Document",
  "E-way Bill dekhein": "View E-way Bill",
  "Extra Document": "Extra Document",
  "Extra Document dekhein": "View Extra Document",
  "Issue Karein": "Issue",
  "Issue ho chuki hai": "Already issued",
  ...
  "Truck Loading Dock par confirm hote hi yahan aata hai — Gate Pass issue karke stock dispatch karein, phir Mark Dispatched karke shipment band karein.":
    "Once a truck is confirmed at the Loading Dock, it lands here — issue a Gate Pass to dispatch the stock, then Mark Dispatched to close the shipment out.",
  "In Transit": "In Transit",
  "Dispatched": "Dispatched",
  "Dispatch candidates load nahi ho paye.": "Could not load Dispatch candidates.",
  "Dispatch list load nahi ho paya.": "Could not load the Dispatch list.",
  "Abhi koi Dispatch candidate nahi hai": "There are no Dispatch candidates yet",
  "Shipment Loading Dock par confirm hote hi wo yahan aa jaayegi.":
    "Once a shipment is confirmed at the Loading Dock, it will show up here.",
  "Issued": "Issued",
  "Invoice Ka Wait Hai": "Waiting on Invoice",
  "Dispatch confirm hote hi wo yahan aa jaayegi.": "Once Dispatch is confirmed, it will show up here.",
  "Gate Pass": "Gate Pass",
  "Assignee": "Assignee",
  "Order Status": "Order Status",
  "Order Poora Dispatch Ho Gaya": "Order Fully Dispatched",
  "Aur Shipments Baaki": "More Shipments Pending",
  "Dispatch Confirm Karein": "Confirm Dispatch",
  "Assignee chunein.": "Choose an assignee.",
  "TAT value 0 se zyada honi chahiye.": "TAT value must be greater than 0.",
  "Dispatch confirm nahi ho paya.": "Could not confirm Dispatch.",
  "Gate Pass issue ho gaya": "Gate Pass issued",
  "Is order ka Invoice abhi Issued nahi hai — Confirm Dispatch tab tak nahi ho sakta jab tak Accounts se Invoice Issue na ho jaaye.":
    "This order's Invoice isn't Issued yet — Confirm Dispatch can't happen until Accounts issues the Invoice.",
  "Shipment Items": "Shipment Items",
  "TAT Value": "TAT Value",
  "TAT Unit": "TAT Unit",
  "Gate Pass Attachment (optional)": "Gate Pass Attachment (optional)",
  "Saving...": "Saving...",
  "Gate Pass Issue Karein — Dispatch Confirm Karein": "Issue Gate Pass — Confirm Dispatch",
  "Dispatch details load nahi ho paye.": "Could not load Dispatch details.",
  "Mark Dispatched nahi ho paya.": "Could not Mark Dispatched.",
  "Shipment Dispatch ho gayi.": "Shipment has been dispatched.",
  "Details aur activity timeline": "Details and activity timeline",
  "TAT": "TAT",
  "Gate Pass Attachment dekhein": "View Gate Pass Attachment",
  "Mark Dispatched": "Mark Dispatched",
  "Proof of Dispatch (optional)": "Proof of Dispatch (optional)",
  "Dispatch ho gaya": "Dispatched by",
  "Proof of Dispatch dekhein": "View Proof of Dispatch",
  "Ye order ab poora Dispatch ho chuka hai — Sales chain ka safar yahan poora hota hai.":
    "This order is now fully dispatched — this is where its journey through the Sales chain ends.",
};
